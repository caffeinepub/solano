...
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string, arg5: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getOrders(): Promise<Array<StoreOrder>> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
